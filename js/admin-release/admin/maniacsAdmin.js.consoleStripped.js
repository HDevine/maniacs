...
// 0 && console.log("Start: ", tempStartDateTime, "  End: ", tempEndDateTime);
// 0 && console.log("Start ISO: ", stamp.toISOString(tempStartDateTime), "  End ISO: ", stamp.toISOString(tempEndDateTime));
    ...
    deletePlayer: function(id) {
      ...
      confirmDialog.on("cancel", function(evt){
         0 && console.log("Cancel button pressed");
      });      
    },
